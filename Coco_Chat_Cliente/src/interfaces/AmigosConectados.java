 ...
 * @author Nancy
 */
public class AmigosConectados extends javax.swing.JFrame {

    /**
     * Creates new form UsuariosConectados
     */
    public AmigosConectados() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmigosConectados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmigosConectados().setVisible(true);
            }
        });
    }
