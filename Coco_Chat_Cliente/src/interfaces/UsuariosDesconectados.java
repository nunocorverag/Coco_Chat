 ...
 * @author Nancy
 */
public class UsuariosDesconectados extends javax.swing.JFrame {

    /**
     * Creates new form UsuariosConectados
     */
    public UsuariosDesconectados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Usuarios desconectados");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosDesconectados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosDesconectados().setVisible(true);
            }
        });
    }
