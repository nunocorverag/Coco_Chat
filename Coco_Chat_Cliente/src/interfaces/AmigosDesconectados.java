 ...
 * @author Nancy
 */
public class AmigosDesconectados extends javax.swing.JFrame {

    /**
     * Creates new form UsuariosConectados
     */
    public AmigosDesconectados() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmigosDesconectados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmigosDesconectados().setVisible(true);
            }
        });
    }
